...
<p>
  <img src="https://img.shields.io/badge/version-2.7.0-2F855A?style=for-the-badge&labelColor=22543D" alt="version 2.7.0">
  <img src="https://img.shields.io/badge/platform-Windows_64--bit-2B6CB0?style=for-the-badge&labelColor=1A365D" alt="Windows 64-bit">
...
<p dir="rtl"><sub>يعمل بلا إنترنت · واجهة عربية كاملة (RTL) · وضعان نهاري وليلي · إعارة متعددة الأجزاء وإرجاع جزئي · باركود وملصقات PDF · بلا إعلانات ولا تتبّع</sub></p>
...
**<img src="https://icongr.am/feather/gift.svg?size=48&color=b0894b" width="16" align="center" alt=""> الجديد في الإصدار 2.7.0**

ثيم **Minimalist** مستوحى من shadcn/ui بهوية رَفّ البنية والذهبية · وضعان نهاري وليلي · قائمة جانبية قابلة للطي · إعارة **جزء واحد أو عدة أجزاء** في عملية واحدة · **إرجاع جزئي** مع تاريخ مستقل لكل جزء · سجل كامل متجاوب مع ترتيب حسب **تاريخ ووقت الإضافة** · فحص سلامة أكثر دقة مع **إصلاح آمن** ونسخة احتياطية تلقائية · منطق موحّد للأرقام المرجعية لا يخلط بين <code>raf-0001</code> و<code>raf-1001</code>
...
<tr><td width="32%" valign="middle"><img src="https://icongr.am/feather/save.svg?size=96&color=b0894b" width="30" align="absmiddle" alt=""> <b>نسخ أمان تلقائية</b></td><td valign="middle">قبل الاستيراد وقبل حذف كل البيانات وقبل أي إصلاح آمن، مع زر نسخة فورية والاحتفاظ بأحدث 20 نسخة.</td></tr>
...
[![Download Raff](https://img.shields.io/badge/Download_Latest_Release-GitHub-8B5E34?style=for-the-badge&labelColor=3E2C1C)](https://github.com/Hzifa33/raff/releases/latest)
...
بعد بناء نسخة **2.7.0**، احسب قيمة **SHA256** لملف الإصدار وضعها هنا لينشرها المستخدمون ويتحققوا بها من سلامة الملف. تتغيّر هذه القيمة مع كل إصدار جديد، لذا احرص على تحديثها قبل النشر.

للتحقق على **Windows PowerShell**، افتح PowerShell داخل مجلد التحميل ونفّذ:

```powershell
certutil -hashfile Raf_Portable_2.7.0.zip SHA256
```
